---
name: compose-avatar-broll-short
...
move-to: .claude/skills/compose-avatar-broll-short/
---

# compose-avatar-broll-short
...
```bash
bash "$BRAND_ROOT/creatives/skills/compose-avatar-broll-short/scripts/composite.sh" \
  --avatar "$AVATAR_MP4" \
  --duration 20 \
...
mempalace_add_drawer(
  ...
  room: "productions",
  name: "{ORD_ID}",
  content: "ORD: {ORD_ID} — compose-avatar-broll-short (2026-04-17)
STATUS: done
